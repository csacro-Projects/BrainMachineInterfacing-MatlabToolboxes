function [time_vector, frequency_vector, channel_spectrogram] = calc_channel_spectrogram(data, sampling_frequency, window_size, step_size)
%calc_channel_spectrogram
%returns the time_vector, frequency_vector and channel_spectrogram with size(channel_average_spectrogram) = [nbSteps, window_size/2, nbChannels, nbTrials]
...
power_spectra = zeros(nbSteps, window_size/2, nbChannels, nbTrials);
for i = 1:nbSteps
    ...
    for t = 1:nbTrials
        ...
        power_spectra(i, :, :, t) = power_spectrum;
    end
end
channel_spectrogram = permute(power_spectra, [2 1 3 4]);
